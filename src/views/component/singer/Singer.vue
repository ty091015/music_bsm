  ...
  <div class="singer">
    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column prop="name" label="歌手姓名" width="100"/>
          ...
          <template #default="scope">
            ...
            >
              ...
              >
                ...
                <img style="height: 35px" :src="scope.row.photo" class="avatar"/>
              </el-upload>
            </el-icon>
          </template>
        </el-table-column>
        <el-table-column prop="sex" label="性别" width="60"/>
        <el-table-column label="歌手简介" width="150" show-overflow-tooltip>
          <template #default="scope">
        ...
        <el-table-column label="操作" width="120">
          <template #default="scope">
            ...
            >
            <el-button type="danger" size="small" @click="deleteSinger(scope.row)"
            >删除
            </el-button
            >
          </template>
